    ...
    <AuthGuard requireAuth={false} redirectTo="/">
      <main className="relative w-full min-h-screen overflow-hidden">
        ...
        <div className="fixed inset-0 pointer-events-none z-5">
          ...
          <div className="absolute top-60 left-60 w-1 h-1 bg-amber-200/15 rounded-full animate-pulse delay-4000"></div>
          <div className="absolute bottom-20 right-60 w-1.5 h-1.5 bg-yellow-500/20 rounded-full animate-pulse delay-5000"></div>
        </div>
